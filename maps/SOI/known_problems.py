...
known_problems = [
    ...
    'data/raw/58C_1.pdf', # Kochi, combined file handled in 58C_5
    ...
    'data/raw/66D_4.pdf', # tamilnadu, combined files handled in 66D_3
    'data/raw/58M_14.pdf', # tamilnadu, combined files handled in 58M_10
    ...
    'data/raw/46D_11.pdf', # daman, combined files handled in 46D_15
