...
Used to have Code to scrape and parse data from [Survey Of India](https://onlinemaps.surveyofindia.gov.in/)

The Open Series Map part of the Code has been moved to [India Topo Maps](https://github.com/ramSeraph/india_topo_maps/tree/main/50k/osm) and [Topo Map Processor](https://github.com/ramSeraph/topo_map_processor)
